...
<main>
    <section class="Featured">
        ...
        <div class="col-md-6 feature-photo"><img src="images/chinese.png" alt="Nifty travel picture" /></div>
    </section>
    ...
    <div class="row match-my-cols">
        <section class="RelatedLinks FirstLink col-md-4">
            <h2>Expert Chinese Translation!</h2>
        ...
        <section class="RelatedLinks SecondLink col-md-4">
            <h2>Chinese-Speaking Tour Guides</h2>
