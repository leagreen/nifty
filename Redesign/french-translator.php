...
<main>
    <section class="Featured">
        ...
        <ul>
            ...
            <li>Je vous tuerai</li>
        </ul>
        <p>&nbsp;</p>
        <p>If not, then read on</p>
        </div>
    
        <div class="col-md-6 feature-photo"><img src="images/french.png" alt="Nifty travel picture" /></div>
    </section>
    ...
    <div class="row match-my-cols">
        <section class="RelatedLinks FirstLink col-md-4">
            <h2>Expert French Translation!</h2>
        ...
        <section class="RelatedLinks SecondLink col-md-4">
            <h2>French-Speaking Tour Guides</h2>
