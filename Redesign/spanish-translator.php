...
<main>
    <section class="Featured">
        ...
        <div class="col-md-6">
            ...
            <ul>
                ...
                <li>Lo mataré pronto</li>
            </ul>
            <p>If not, then read on</p>
        </div>
    
        <div class="col-md-6 feature-photo"><img src="images/spanish.png" alt="Nifty travel picture" /></div>
    </section>
    ...
    <div class="row match-my-cols">
        <section class="RelatedLinks FirstLink col-md-4">
            <h2>Expert Spanish Translation!</h2>
        ...
        <section class="RelatedLinks SecondLink col-md-4">
            <h2>Spanish-Speaking Tour Guides</h2>
        ...
        <section class="RelatedLinks ThirdLink col-md-4">
            <h2>Interpreter Services Available</h2>
