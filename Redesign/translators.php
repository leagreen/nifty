...
<main>
    <section class="Featured">
        <div class="col-md-6">
            ...
            <ul>
                ...
                <li>Helped iron out treaty disputes</li>
                <li>Found numerous hard-to-find restrooms</li>
            </ul>
        </div>

    <div class="col-md-6 feature-photo"><img src="images/translators.png" alt="Nifty travel picture" /></div>
    ...
    <div class="row match-my-cols">
        <section class="RelatedLinks FirstLink col-md-4">
            <h2><a href="french-translator.php">French</a></h2>
        ...
        <section class="RelatedLinks SecondLink col-md-4">
            <h2><a href="chinese-translator.php">Chinese</a></h2>
        ...
        <section class="RelatedLinks ThirdLink col-md-4">
            <h2><a href="spanish-translator.php">Spanish</a></h2>
